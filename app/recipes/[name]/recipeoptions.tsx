...
export default function RecipeOptions({recipeId}: {recipeId: number}){
    ...
    if (!user) return <Link href={`/api/auth/login`} style={{ color: 'white' }}>Please log in to edit and favorite recipies!</Link>
    return(
        <div style={{ 
            height: "5rem",
            display: 'grid',
