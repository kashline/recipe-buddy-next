...
export default withPageAuthRequired(function Page() {
  ...
  const onInvalid = (e: React.FormEvent) => {
    ...
    return(
        <span className="invalid:visible text-chili-red">You must supply a title</span>
    )
  }
  return (
      ...
      <div className="border-2 border-black py-2 w-full max-w-[600px] justify-center mx-auto">
        <form className="mx-0" onSubmit={handleSubmit} noValidate={true}>
          <div className=" w-full px-2">
            ...
            />
            {selectRecipe.title === "" && !formValid && <div className="text-chili-red">{`Title is required`}</div>}
          </div>
          ...
          <div className=" w-full px-2">
            ...
            />
            {selectRecipe.description === "" && !formValid && <div className="text-chili-red">{`Description is required`}</div>}
          </div>
          <div className=" w-full px-2">
            <label className="text-lavendar-blush my-auto pr-2 font-sans">
              Preparation Time:
          ...
          <div className="py-2 w-full max-w-[600px] justify-center mx-auto flex gap-6 pt-8">
            ...
            <div>
              <button className="text-lavendar-blush border-2 border-gray-500 w-fit px-5 rounded-md hover:border-non-photo-blue h-8">
                Cancel
              </button>
            </div>
          </div>
