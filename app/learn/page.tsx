...
export default function Page(){
    return(
        <div style={{ 
            ...
            <p>Our dedicated chef LLM&apos;s will guide you through any recipe you can think of, but here you can get guidance on a curated list of easy-to-start recipes.</p>
            ...
            <table>
                <button style={{ height: '100%', color: 'white'}}>
                    ...
                    <td>Quick and easy, this recipe will give you a great homecooked meal and teach you the basics on making bread and sauces from scratch!  Substitute for vegitarian, vegan, or gluten free!</td>
                </button>
            </table>
